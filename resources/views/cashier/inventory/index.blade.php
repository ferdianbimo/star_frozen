        ...
        <div class="flex-1 overflow-y-auto">
            <header class="bg-white shadow">
                <div class="py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <div>
                        <a href="{{ route('cashier.inventory.low-stock') }}" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md text-sm">
                            Low Stock Items
                        </a>
                    </div>
                </div>
            ...
            <main class="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 bg-white rounded-lg shadow p-4">
                    <form action="{{ route('cashier.inventory.index') }}" method="GET" class="flex flex-wrap gap-4">
                        ...
                        <div class="w-40">
                            ...
                            <select name="category" id="category" class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-200 focus:border-green-500">
                        ...
                        <div class="w-40">
                            ...
                            <select name="sort" id="sort" class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-200 focus:border-green-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $product->hasLowStock() ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                            {{ $product->stock }} units
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('cashier.inventory.show', $product) }}" class="text-blue-600 hover:text-blue-900 mr-3">
